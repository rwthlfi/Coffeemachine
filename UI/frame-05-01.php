...
<head>
  ...
  <title>Frame 05-01</title>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter%3A400"/>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro%3A400"/>
  <link rel="stylesheet" href="./styles/frame-05-01.css"/>
  <script>
...
<body>
<div class="frame-05-01-t1Z">
  <div class="page-27m">
    <img class="logo-NhR" src="./assets/Logo.png"/>
    <div class="pop-window-uhM">
    </div>
    <div class="kaffee-kommt-b4P">2x Kaffee kommt...</div>
  </div>
</div>
</body>
</html>
