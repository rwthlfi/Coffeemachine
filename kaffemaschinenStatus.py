...
try:
    while True:
        ...
        if is_blinking(LED_GPIO_PIN_6, 2, 2) and not GPIO.input(LED_GPIO_PIN_9):
            print("Es wurde die Funktion „vorgemahlener Kaffee“ gewählt, aber das vorgemahlene Kaffeepulver wurde nicht eingefüllt")
        if is_blinking(LED_GPIO_PIN_6, 2, 2) and not previous_states[LED_GPIO_PIN_9] and not previous_states[LED_GPIO_PIN_9] and is_blinking(LED_GPIO_PIN_9, 2, 2):
